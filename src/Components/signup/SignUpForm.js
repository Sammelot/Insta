        ...
        return (
            <div className="center">
                <form onSubmit={this.showUserPass} className="login-form">
                    ...
                    <input required="required" className="textPersonalizado" type="text" id="name " name="names"
                           placeholder="Nombre" onChange={this.handleChange}/>

                    <label htmlFor="apellido">Apellidos</label>
                    <input required="required" className="textPersonalizado" type="text" id="apelli " name="apellido"
                           placeholder="Apellidos" onChange={this.handleChange}/>


                    <label htmlFor="email">Correo</label>
                    <input required="required" value={usuario.correo} className="emailLogin" type="email" id="email"
                           name="email" placeholder="Correo electrónico" onChange={this.handleChange}/>

                    <label htmlFor="password">Contraseña</label>
                    <input required="required" value={usuario.password} type="password" id="password" name="password"
                           placeholder="Contraseña" onChange={this.handleChange}/>

                    <label htmlFor="passwordMatch">Contraseña</label>
                    <input required="required" value={this.state.passwordMatch} type="password" id="passwordMatch"
                           name="passwordMatch" placeholder="Confirmar contraseña" onChange={this.handleChangeMatch}/>
